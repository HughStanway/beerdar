...
<header class="w-full max-w-xl mx-auto px-4 pt-4 mb-6">
  <div class="w-full py-3 px-4 flex items-center justify-between border-4 border-black bg-white shadow-[4px_4px_0px_#000]">
    <!-- Arcade Title -->
